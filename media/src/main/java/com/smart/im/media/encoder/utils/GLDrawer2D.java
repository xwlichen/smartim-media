package com.smart.im.media.encoder.utils;
...
public class GLDrawer2D {
    ...
    public static int loadShader(final String vss, final String fss) {
        ...
        if (compiled[0] == 0) {
            if (DEBUG) {
                LogUtils.w(TAG, "Failed to compile fragment shader:"
