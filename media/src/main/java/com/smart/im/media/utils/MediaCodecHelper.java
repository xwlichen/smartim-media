...
//    public static MediaCodec createSoftVideoMediaCodec(PushConfig config, MediaFormat videoFormat) {
//        videoFormat.setString(MediaFormat.KEY_MIME, "video/avc");
//        videoFormat.setInteger(MediaFormat.KEY_WIDTH, config.getPreviewWidth());
//        videoFormat.setInteger(MediaFormat.KEY_HEIGHT, config.getPreviewHeight());
...
//    }
//
//    public static MediaCodec createAudioMediaCodec(RESCoreParameters config, MediaFormat audioFormat) {
//        //Audio
//        MediaCodec result;
...
//    }
    ...
    public static MediaCodec createHardVideoMediaCodec(PushConfig config, MediaFormat videoFormat) {
        videoFormat.setString(MediaFormat.KEY_MIME, "video/avc");
        videoFormat.setInteger(MediaFormat.KEY_WIDTH, config.getWidth());
        videoFormat.setInteger(MediaFormat.KEY_HEIGHT, config.getHeight());
        videoFormat.setInteger(MediaFormat.KEY_COLOR_FORMAT, MediaCodecInfo.CodecCapabilities.COLOR_FormatSurface);
        videoFormat.setInteger(MediaFormat.KEY_BIT_RATE, config.getVideoBitRate());
        videoFormat.setInteger(MediaFormat.KEY_FRAME_RATE, config.getFps().value());
        videoFormat.setInteger(MediaFormat.KEY_I_FRAME_INTERVAL, config.getAvcIFrameInterval());
        videoFormat.setInteger(MediaFormat.KEY_PROFILE, MediaCodecInfo.CodecProfileLevel.AVCProfileBaseline);
        videoFormat.setInteger(MediaFormat.KEY_LEVEL, MediaCodecInfo.CodecProfileLevel.AVCLevel31);
        videoFormat.setInteger(MediaFormat.KEY_BITRATE_MODE, MediaCodecInfo.EncoderCapabilities.BITRATE_MODE_CBR);
